return {
  ...
  {
    "DAP",
    { "Set breakpoint (<leader>b)", ":lua require('dap').toggle_breakpoint()" },
    { "Set breakpoint with condition (<leader>B)", ":lua require('dap').set_breakpoint(vim.fn.input('Breakpoint condition: '))" },
    { "Set breakpoint with log info (<leader>lp)", ":lua require('dap').set_breakpoint(nil, nil, vim.fn.input('Log point message: '))" },
    { "Continue <F9>", ":lua require('dap').continue()" },
    { "Stepinto <F10>", ":lua require('dap').step_into()" },
    { "Stepout  <F11>", ":lua require('dap').step_out()" },
    { "Stepover <F12>", ":lua require('dap').step_over()" },
    { "Stepover <F8>", ":lua require('dap').terminate()" },
    { "Open repl (<leader>dr)", ":lua require('dap').repl.open()" },
